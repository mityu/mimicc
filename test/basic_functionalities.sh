...
assert() {
  ...
  ../mimic ./Xtmp/tmp.c > ./Xtmp/tmp.s
  gcc -o ./Xtmp/tmp ./Xtmp/tmp.s
  ./Xtmp/tmp
  actual="$?"
...
assert_fcall() {
  ...
  ../mimic ./Xtmp/tmp1.c > ./Xtmp/tmp1.s
  gcc -c -o ./Xtmp/tmp1.o ./Xtmp/tmp1.s
  gcc -c -o ./Xtmp/tmp2.o -x c <(echo "$restcode")
  gcc -o ./Xtmp/tmp ./Xtmp/tmp1.o ./Xtmp/tmp2.o
  ./Xtmp/tmp
  actual="$?"
